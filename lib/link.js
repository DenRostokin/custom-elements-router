  ...
  _createClass(CustomLink, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props2, ["innerRef", "to", "children", "context", "replace"]);

      var location = context && typeof to === 'string' ? (0, _history.createLocation)(to, null, null, context.location) : to;
      var href = context && location ? context.history.createHref(context.location) : '';
      var otherProps = innerRef ? _objectSpread({}, rest, {
        ref: innerRef
      }) : rest;
