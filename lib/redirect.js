...
function (_Component) {
  ...
  _createClass(CustomRedirect, [{
    ...
    value: function componentDidCreate() {
      ...
      var redirectComputedMatch = route ? route.computedMatch : computedMatch;
      var location = (0, _history.createLocation)(redirectComputedMatch ? typeof redirectTo === 'string' ? (0, _generatePath.default)(redirectTo, redirectComputedMatch.params) : _objectSpread({}, redirectTo, {
        pathname: (0, _generatePath.default)(redirectTo.pathname, redirectComputedMatch.params)
      }) : redirectTo);
